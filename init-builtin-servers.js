...
async function initializeBuiltInServers() {
  ...
  const builtInServers = [
    ...
    },
    {
      ...
      type: 'stdio',
      cmd: 'npx',
      args: ['-y', '@modelcontextprotocol/server-filesystem', process.env.WINGMAN_CODE_PATH || require('os').homedir() + '/code'],
      timeout: 300,
      env_keys: [],
    ...
    },
    {
      ...
      type: 'stdio',
      cmd: 'npx',
      args: ['-y', '@danielsuguimoto/readonly-server-filesystem', process.env.WINGMAN_CODE_PATH || require('os').homedir() + '/code'],
      timeout: 300,
      env_keys: [],
